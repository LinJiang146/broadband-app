  ...
  <div>
          ...
          <el-form ref="form" :model="missionForm" label-width="80px">
            ...
            <el-form-item label="任务分类">
              <el-select v-model="missionForm.walletItemId" placeholder="请选择任务分类">
                <el-option v-for="item in walletItemList" v-show="missionForm.type == item.type" :label="item.description"
    ...
    <el-row v-show="activeName == 'second'">
      <div class="filter">
        ...
        <el-col :span="5">
          <el-select clearable v-model="itemFilter.packageId" placeholder="完成情况">
...
export default {
  data() {
    return {
      missionItemForm: { description: "", amount: null, packageId: null, type: 0 },
      missionForm: { walletItemId: null, phone: null, userId: null, isRoutine: 0, type: 0 },
